...
__all__ = ['dbus_error', 'dbus_error_by_default', "register"]
...
def map_error(error_name, error_register=register):
    """Map decorated exception class to a DBus error."""
    def decorated(cls):
        error_register.map_exception_to_name(cls, error_name)
        return cls

    return decorated


def map_by_default(cls, error_register=register):
    """Map decorated exception class to all unknown DBus errors."""
    error_register.set_default_exception(cls)
    return cls
