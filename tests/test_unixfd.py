...
class DBusForkedTestCase(DBusTestCase):
    ...
    def setUp(self):
        ...
        self.proxy_args = {"client": GLibClientUnix}

    def test_xml_specification_with_unix(self):
        """Test the generated specification of Unix types."""
    ...
    def _run_test(self):
        ...
        for func, name in self.clients:
            cmd = f"""
from tests.test_unixfd import {func}
import sys
...
"""
        ...
        for client in proc:
            client.stdin.write(bytes(self.message_bus.address + "\n", "utf-8"))
            client.stdin.close()
