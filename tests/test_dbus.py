...
class TestMessageBus(AddressedMessageBus):

    def __init__(self, *args, **kwargs):
        self._dbus_daemon = self._start_daemon()
        address = self._dbus_daemon.get_bus_address()
    ...
    def disconnect(self):
        super().disconnect()
        self._dbus_daemon.down()
        self._dbus_daemon = None
...
class DBusThreadedTestCase(DBusTestCase):
    ...
    def test_message_bus(self):
        ...
        self.assertTrue(self.message_bus.address)
